...
def main():
    try:
        ...
        venv_bin = '/home/ubuntu/back/atomic-back/atomic/venv/bin'
        ...
        # Reiniciar Gunicorn
        try:
            run_command("sudo systemctl stop gunicorn_atomic")
        except subprocess.CalledProcessError:
            # Si el servicio no estaba corriendo, no hacer nada
            pass
        run_command("sudo systemctl start gunicorn_atomic")
        run_command("sudo systemctl enable gunicorn_atomic")
        run_command("sudo systemctl restart gunicorn_atomic")
